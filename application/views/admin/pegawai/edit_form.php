					...
					<div class="card-body">
						...
						<form action="<?php base_url('admin/pegawai/edit') ?>" method="post" enctype="multipart/form-data">
							...
							<div class="form-group">
								...
								<input class="form-control <?php echo form_error('nip') ? 'is-invalid' : '' ?>" type="number" name="nip" min="0" placeholder="NIP pegawai" value="<?php echo $pegawai->nip ?>" />
							...
							<div class="form-group">
								...
								<input class="form-control <?php echo form_error('nama') ? 'is-invalid' : '' ?>" type="text" name="nama" placeholder="Nama pegawai" value="<?php echo $pegawai->nama ?>" />
								<div class="invalid-feedback">
							...
							<div class="form-group">
								...
								<input type="hidden" name="old_image" value="<?php echo $pegawai->image ?>" />
								<div class="invalid-feedback">
							...
							<div class="form-group">
								...
								<select class="form-control <?php echo form_error('id_jabatan') ? 'is-invalid' : '' ?>" name="id_jabatan">
									<option value="<?php echo $pegawai->id_jabatan ?>" class="text-muted alert alert-primary"><?php echo $pegawai->jabatan ?></option>
									<?php
